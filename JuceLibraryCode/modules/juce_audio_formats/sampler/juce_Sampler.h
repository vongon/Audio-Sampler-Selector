...
private:
    ...
    int midiRootNote;
    int Channel;
    int xfadeSamples; //xfade length in samples
    int xloopBuffer; //xfade buffer length from start and end of sound file, for smooth looping
...
private:
    ...
    bool xfade; //for sounds xfade status
    float xAttackLevel, xReleaseLevel, xAttackDelta, xReleaseDelta; //for xfade envelopes
    double xAttackSamplePosition; //for xfade attack sample position
